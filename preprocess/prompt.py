...
task_mapping = {
    # Regression
    'esol': ("Based on these inputs, please analyze the property of the molecule (e.g. Functional groups, Structural   characteristics), and which proporties of the molecule can affect its water solubility? Also try to guess its solubility. "
    ),
    ...
    'bbbp': ("As a membrane separating circulating blood and brain extracellular ﬂuid, "
            ...
            "Based on these inputs, please analyze the property of the molecule (e.g. Functional groups, Structural characteristics) and analyze if the molecule is permeable to the blood-brain barrier?"
            ),
    
    'hiv': ("The HIV dataset tests the ability to inhibit HIV replication for over 40,000 compounds. Based on the following inputs, please analyze the property of the molecule (e.g. Functional groups, Structural characteristics) with focusing on its ability to inhibit HIV replication. Then make your guess or prediction (active or inactive)."
            ), 
    ...
    'bace': ("The BACE dataset provides and binary label binding results for a set of inhibitors of human β-secretase 1 (BACE-1)"  
             "Based on the following inputs, please analyze the property of the molecule (e.g. Functional groups, Structural characteristics) and analyze the binding results for a set of inhibitors of human beta-secretase (BACE-1)?"
    ),
}
