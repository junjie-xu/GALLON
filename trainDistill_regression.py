...
def get_best_lm_path(dataname, split_method, seed):
    if split_method == 'random_scaffold':
        best_lm_path = {
            ...
            'freesolv': f'prt_lm/freesolv/random_scaffold/roberta-base_20_0.3_{seed}_0_True', 
            'esol': f'prt_lm/esol/random_scaffold/roberta-base_20_0.3_{seed}_0_True', 
            'lipo': f'prt_lm/lipo/random_scaffold/roberta-base_20_0.3_{seed}_0_True', 
        }
...
class DistillTrainer():
    ...
    def _train(self):
        ...
        for data in self.train_loader:
            ...
            loss = y_loss + 1 * gnn_rep_loss + 0.1 * lm_rep_loss
            
            # print(logits.squeeze().shape, data.y.shape)
